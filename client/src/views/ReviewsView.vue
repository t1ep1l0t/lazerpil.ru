    ...
    <div class="container">
      <div class="status__inner">
        <div class="status__count">
          {{ $store.state.reviews_summary }}
        </div>
        <div class="status_content">
          <div class="status__stars">
            <svg v-for="item of Math.round($store.state.reviews_summary)" :key="item" width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="status__length">
            {{ $store.state.reviews.length }} оценки
          </div>
        </div>
      </div>
    </div>
